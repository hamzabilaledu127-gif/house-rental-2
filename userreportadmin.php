...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To View Free House Report</b><!-- InstanceEndEditable --></div>
     	</br>
...
<?php    $con = mysqli_connect('localhost', 'root', '','house');?>
      ...
      echo '<th bgcolor="#336699"><font color="white" size="2">User Name.</th><th bgcolor="#336699" ><font color="white" size="2">User type.</th><th bgcolor="#336699"><font color="white" size="2">Status.</th>';
    $rowcolor=0;
  ...
  print ("<tr>");
   print ("<td ><font size='2' >" . $row['username'] . "</td>");
    ...
    print ("<td ><font size='2' >" . $row['usertype'] . "</td>"); 
