...
<td width="950" height="29" background-color="606060" margin-top="-15">
  ...
  <li><a href="https://www.latlong.net/">Coordinate</a></li>
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'viewhousedetailcus.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
