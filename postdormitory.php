...
<div id="footer_icon">
 ...
 <div id="navbar">
  ...
  <div id="main_body">
<form name="form1" id="f1" action="dormitory.php" method="post" enctype="multipart/form-data" onsubmit='return formValidator();'>
  <table  align="center">
    ...
    <tr>
      ...
      <tr>
          <td colspan=2 align="center" ><u>Include Services</u></td>
    </tr>
    <tr><td> <input type="CHECKBOX" id="CHECKBOX_1" name="CHECKBOX_1" value="Internet"></td><td>Internet</td></tr>
    <tr><td><input type="CHECKBOX" id="CHECKBOX_2" name="CHECKBOX_2" value="Water"></td><td>Water</td>
    <tr><td align="center"><input type="CHECKBOX" id="CHECKBOX_3" name="CHECKBOX_3" value="electricity"></td><td>Electricity </td></tr>
        <tr><td align="center"><input type="CHECKBOX" id="CHECKBOX_3" name="CHECKBOX_3" value="electricity"></td><td>Parking </td></tr>
    <tr><td align="center"><input type="CHECKBOX"  id="CHECKBOX_4" name="CHECKBOX_4" value="no"></td><td>Absent any services </td></tr>
