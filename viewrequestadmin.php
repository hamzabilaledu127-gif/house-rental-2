...
<tr >
     <td class="left_container"  height="100" width="100px" valign="
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'viewdetailcus.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
		<td><a href = 'request.php?key=".$ctrl."'><img src = 'images/request.png' width='60px' height='25px' title='request' ></img></a></td>
