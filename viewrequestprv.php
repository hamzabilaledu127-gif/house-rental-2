...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'viewrequestdetailemp.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
		<td><a href = 'sendresponseprv.php?key=".$ctrl."'><img src = 'IMG/done.jpg' width='45px' height='25px' title='confirm' ></img></a></td></img></a></td>
    <td><a href = 'deleterequestprv.php?key=".$ctrl."'><img src = 'IMG/remove.png' width='45px' height='25px' title='delete' ></img></a></td>
