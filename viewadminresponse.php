...
$query = "SELECT * FROM activationresponse";
//$query="SELECT * FROM account ";
$result = mysqli_query($con,$query);
echo "<table border='1' style='width:550px;border:1px solid black;border-radius:10px;' align='center'>
<tr>
<th>UserName</th>
<th>Email</th>
<th>HouseNumber</th>
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['date'] . "</td>");	
		print("<td align = 'center' width = '1'><a href = 'accountresponseprvdelete.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/remove.png' title='remove'></img></a></td>
");
  print ("</tr>");
