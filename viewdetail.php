...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To View Detail Of House</b><!-- InstanceEndEditable --></div>
     	</br
...
<tr>
<td></td>
<td align="right"><a href="viewhouse.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
