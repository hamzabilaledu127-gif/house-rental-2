...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
    ...
    <p><span class="style1"> Services provided by Gondar City House Rental System :</span></p>
    <pre><p> 
	            * Post different living and bussiness working houses to be rented.
		       * Receives customer feedback and correct any mistake
		       * Give a response for customers imideately 
		and others...
	    </p></pre>
