...
<tr>
<td>User Name :</td><td><input name="username" type="text" size"20"  required="required" placeholder="Enter username"></input></td>
</tr>
<tr>
<td>House Number :</td><td><input name="housenumber" type="number" size"20"  title="it must be number" required Pattern="[0-9]{1,10}"></input></td>
</tr>
