...
<form name="form1" id="f1" action="houseregistrationemp.php" method="post" enctype="multipart/form-data" onsubmit='return formValidator();'>
  <table  align="center">
  
      <tr>
      <td>First Name </td>
      <td >
        <input name="fname" type="text" id="fname"  required   Pattern="[A-Za-z]{3,20}"  title=" it must be charcter" />
      
    </tr>
    <tr>
      <td>Last Name </td>
      <td>
        <input name="lname" type="text" id="lname" required   Pattern="[A-Za-z]{3,20}"  title=" it must be charcter"/>
     </td>
    </tr>
    <tr>
      <td >Email </td>
      <td>
        <input name="email" type="text" id="email"  required Pattern="[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}" title="please enter valid email"/>
      </td>
    </tr>
    <tr>
      <td >Phone Number </td>
      <td >
        <input name="contact"  type="text" id="contact" title="it must be number" required Pattern="[0-9]{10,13}" />
      </td>
    </tr>
         <tr>
      <td >kebele </td>
      <td >
        <input name="kebele" type="text" id="kebele" title="it must be number" required Pattern="[0-9]{1,2}" />
      </td>
    </tr>
          <tr>
      <td >No-Of-Room </td>
      <td >
        <input name="room" type="text" id="room" title="it must be number" required Pattern="[0-9]{1,10}"/>
      </td>
    </tr>
         <tr>
      <td >House Number </td>
      <td >
        <input name="housenumber" type="text" id="property" title="it must be number" required Pattern="[0-9]{1,10}"/>
      </td>
    </tr>
         <tr>
      <td>Price </td>
      <td >
        <input name="price" type="text" id="price" title="it must be number" required Pattern="[0-9]{1,10}"/>
      </td>
    </tr>
         <tr>
      <td >Floor </td>
      <td>
        <input name="floor" type="text" id="floor" title="it must be number" required Pattern="[0-9]{1,10}"/>
      </td>
        </tr>
      ...
      <td >upload image</td>
      <td >
        <input name="images" type="file" id="images"  required />
     </td>
    </tr>
       <tr>
      <td a>type of House:</td>
    
     </strong></div></td>
            <td  align="left">
          <select id='type' name="type" style="width:175px;" "height:20px;" margin-left="2px"  required>
