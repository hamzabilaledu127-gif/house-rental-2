...
<div id="footer_icon">
 ...
 <div id="navbar">
      <ul id="navmenu">
                   ...
                   <li><a href="deletefeedbackemp.php"> View Feedback</a></li>                          </ul>
                                     </li>
...
<form name="form1" id="f1" action="Houseregistration.php" method="post" enctype="multipart/form-data" onsubmit='return formValidator();'>
  <table  align="center">
    ...
    <tr><td>House type: </td><td class="inputform"><select name="type" id="type" >
                <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
        <option value="Private house">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;private house </option>
        <option value="governmental house">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;governmental house </option>
