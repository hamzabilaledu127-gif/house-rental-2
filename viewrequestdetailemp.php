...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
  ...
  <?php
$ctrl = $_REQUEST['key'];
$query="SELECT * FROM  request1 where housenumber='{$ctrl}'";
...
<tr>
<td></td>
<td align="right"><a href="viewrequestemp.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
...
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>House Number:</b></td><td><?php echo $row2?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Reason:</b></td><td><?php echo $row3?></td>
</tr>
<tr>
