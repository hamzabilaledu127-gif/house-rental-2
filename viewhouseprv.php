...
$query = "SELECT * FROM register where type='private house'";
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'viewdetailprv.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
		<td><a href = 'edithouseprv.php?key=".$ctrl."'><img src = 'IMG/edit.jpg' width='25px' height='25px' title='Edit' ></img></a></td>
		<td align = 'center' width = '1'><a href = 'deletehouse.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/remove.png' onclick='isdelete();' title='Delete'></img></a></td>
		");
  print ("</tr>");
