...
<td width="950" height="29" background-color="606060" margin-top="-15">
	<div id="topnav" >
        ...
        <li><a href="updatehouse.php">UpdateHouse</a></li>
...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
  ...
  <?php
$ctrl = $_REQUEST['key'];
$query="SELECT * FROM  response where housenumber='{$ctrl}'";
...
<tr>
<td></td>
<td align="right"><a href="viewresponsecus.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
<td><font face="times new roman" color="#336699" size="3"><b>Sendername:</b></font></td><td><?php echo $row0?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>HouseNumber:</b></td><td><?php echo $row1?></td>
</tr>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Message:</b></td><td><?php echo $row2?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>CustomerEmail:</b></td><td><?php echo $row3?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Price:</b></td><td><?php echo $row4?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Time:</b></td><td><?php echo $row5?></td>
</tr>
<tr>
<td><br></td>
</tr>
