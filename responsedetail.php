...
<td  bgcolor="  #ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
    ...
    <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To view Detail Of landlord Request</b><!-- InstanceEndEditable --></div>
      </br>
 

  <?php
$ctrl = $_REQUEST['key'];
$query="SELECT * FROM  leavehouse where username='{$ctrl}'";
...
<tr>
<td></td>
<td align="right"><a href="accountresponse.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
<td><font face="times new roman" color="#336699" size="3"><b>UserName:</b></font></td><td><?php echo $row0?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Email:</b></td><td><?php echo $row1?></td>
</tr>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>HouseNumber:</b></td><td><?php echo $row2?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Message:</b></td><td><?php echo $row3?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Date:</b></td><td><?php echo $row4?></td>
</tr>
<tr>
<td><br></td>
</tr>
