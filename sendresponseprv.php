...
$con = mysqli_connect('localhost','root', '','house');//Records per page?>
 ...
 <FORM ACTION="sendresponseprv.php" METHOD="POST" enctype="multipart/form-data">
...
if(!$result){
   ...
   echo' <meta content="5;sendresponseprv.php" http-equiv="refresh" />'; 
}
...
echo"Time:&nbsp;&nbsp;&nbsp;".$ti."<br>";
 $update = mysqli_query($con,("update register set status='reserved' WHERE housenumber='{$hn}'")) or die(mysqli_error());
   echo' <meta content="20;sendresponsprv.php" http-equiv="refresh" />';  
