...
$con = mysqli_connect('localhost','root', '','house');//Records per page?>
 ...
 <FORM ACTION="sendleavehouserequest.php" METHOD="POST" enctype="multipart/form-data">
...
<tr>
<td>User Name :</td><td><input name="username" type="text" size"20"  required placeholder="Enter customer username"></input></td>
</tr><tr>
<td>Email :</td><td><input name="email" type="text" size"20"  required Pattern="[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}" title="please enter valid email"></input></td>
</tr>
<tr>
<td>HouseNumber :</td><td><input name="housenumber" type="number" size"20" title="it must be number" required Pattern="[0-9]{1,10}"></input></td>
</tr>
<tr>
<tr>
<td>Message :</td><td><input name="message" type="text" size"20" pattern="\D{4,50}" required="required" placeholder="Enter  reason"></input></td>
</tr>
...
$sql="insert into leavehouse (username,email,housenumber,message,date)
  values('$_POST[username]','$_POST[email]','$_POST[housenumber]','$_POST[message]','$_POST[date]')";  
     $result=mysqli_query($con,$sql);  
if(!$result){
    print "<img src='IMG/error.png' align='center' width='25px' height='25px'><font face='arial' color='red' size='2'> Invalid Entry!!</font>";
   echo' <meta content="5;leavehouserequestemp.php" http-equiv="refresh" />'; 
}

else{ 
      
  echo'  <p align="center"><font color="green" size="2"><img width="30px" height="30px" src="IMG/tick.png">&nbsp;&nbsp; Request Successfuly !</font></p>';
