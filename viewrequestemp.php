...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		...
		<td><a href = 'sendresponseemp.php?key=".$ctrl."'><img src = 'IMG/done.jpg' width='45px' height='25px' title='confirm' ></img></a></td></img></a></td>
    <td><a href = 'deleterequestemp.php?key=".$ctrl."'><img src = 'IMG/remove.png' width='45px' height='25px' title='delete' ></img></a></td>
