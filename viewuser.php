...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To Manage Account</b><!-- InstanceEndEditable --></div>
     	</br>
     	<center>

  
<table align="center" border='1' style='width:500px;border:1px solid black;border-radius:10px;' align='left'>
<tr>
<th>User Name</th>
<th>Account Type</th>
...
<td><?php echo $ctrl;?></td>    
<td align = 'center' width = '1'><a href = 'viewuserdetail.php?key=<?php echo $ctrl;?>'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
    <td><a href = 'edituser.php?key=<?php echo $ctrl;?>'><img src = 'IMG/edit.jpg' width='25px' height='25px' title='Edit' ></img></a></td>
    <td><?php
            if(($status)=='0')
            {
            ?>
                             <a href="status.php?status=<?php echo $row['username'];?>" onclick="return confirm('Really you activate (<?php echo $emp_id?>)');">
            ...
            {
            ?>
                             <a href="status.php?status=<?php echo $row['username'];?>" onclick="return confirm('Really you De-activate (<?php echo $emp_id?>)');"> 
