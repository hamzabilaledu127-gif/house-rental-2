...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To View User Account</b><!-- InstanceEndEditable --></div>
     	</br>
 

  <?php
$ctrl = $_REQUEST['key'];
$query="SELECT * FROM  account where userName='{$ctrl}'";
...
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Account Type:</b></td><td><?php echo $row2?></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Password:</b></td><td><?php echo $row3?></td>
</tr>
<tr>
<td><br></td>
</tr>
