...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To Manage House</b><!-- InstanceEndEditable --></div>
     	</br>
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['housenumber'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'viewdetail.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
		<td><a href = 'edithouse.php?key=".$ctrl."'><img src = 'IMG/edit.jpg' width='25px' height='25px' title='Edit' ></img></a></td>
